...
var ReactResumableJs = function (_React$Component) {
    ...
    function ReactResumableJs(props) {
        ...
        _this.complete = function () {
            ...
            for (var i = 0; i < _this.state.fileList.files.length; i++) {
                _this.resumable.removeFile(currentFileList[i]);
            }
            ...
            if (typeof _this.props.onCompleteUpload === "function") {
...
ReactResumableJs.defaultProps = {
    ...
    onCompleteUpload: function onCompleteUpload() {
